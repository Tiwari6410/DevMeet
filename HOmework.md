...
- Explore validator library function and use validator funct for password, email , photoURL
...
- Create a list all API you can think of in DevMeet.
- Group multiple routes under respective reouters.
